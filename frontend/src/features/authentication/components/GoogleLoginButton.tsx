...
import { useGoogleLogin } from "@/features/authentication/hooks/useAuth";
...
export function GoogleLoginButton() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {googleLogin.isError && (
        <p role="alert" className="text-center text-xs font-medium text-sunset-600">
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
      ...
      <path
        fill="#FBBC05"
        d="M3.95 10.7A5.4 5.4 0 0 1 3.66 9c0-.59.1-1.16.29-1.7V4.97H.94A9 9 0 0 0 0 9c0 1.45.35 2.83.94 4.03l3.01-2.33z"
      />
      <path
        fill="#EA4335"
