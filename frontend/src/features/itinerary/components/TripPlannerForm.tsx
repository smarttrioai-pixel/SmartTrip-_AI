...
import {
  ...
  type GenerateItineraryFormValues,
} from "@/features/itinerary/domain/schemas";
...
interface TripPlannerFormProps {
  /** Called immediately when the user clicks Generate (before the API request fires) */
  onGenerationStart?: () => void;
  /** Called with the generated trip on success */
...
export function TripPlannerForm({
  ...
  //     the OS-level double-click from reaching the form submit handler.
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
      ...
      <Controller
        ...
        name="travelStyle"
        render={({ field }) => (
          <Select label="Travel style" options={TRAVEL_STYLES} {...field} />
        )}
      />
