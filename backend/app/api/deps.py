...
def get_live_context_engine_dep() -> LiveContextEngine:
    """Construct LiveContextEngine (uses WeatherService singleton internally)."""
    return get_live_context_engine()
...
def get_planning_engine(
    ...
    live_context_engine: Annotated[LiveContextEngine, Depends(get_live_context_engine_dep)],
) -> PlanningEngine:
    return PlanningEngine(
        ...
        live_context_engine=live_context_engine,
    )
