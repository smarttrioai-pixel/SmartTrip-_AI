...
from app.engines.retrieval_engine import RetrievalEngine, get_retrieval_engine as _get_engine_singleton
...
# ---------------------------------------------------------------------------
# Phase 5 — Retrieval Engine (process-level singleton)
# ---------------------------------------------------------------------------

def get_retrieval_engine() -> RetrievalEngine:
    """
    Returns the process-level singleton RetrievalEngine.
    The engine holds the three vector indexes and the cache, so it must be
    a singleton — creating a new instance per request would lose all indexed
    documents.
    """
...
# ---------------------------------------------------------------------------
# SCIF Cognitive Engines (wired with RetrievalEngine)
# ---------------------------------------------------------------------------
...
def get_memory_engine(
    ...
    return MemoryEngine(memory_repo, chat_repo, retrieval_engine)
...
def get_recommendation_engine(
    ...
    return RecommendationEngine(context_engine, retrieval_engine)
...
def get_chat_service(
    ...
    return ChatService(repo, memory_engine, retrieval_engine)
