...
async def generate_itinerary(
    ...
    try:
        ...
        # Raised by LLMService when the AI provider (HuggingFace by default)
        # is not configured or returns an error. The provider is selected by
        # LLM_PROVIDER env var — no code change needed to switch providers.
