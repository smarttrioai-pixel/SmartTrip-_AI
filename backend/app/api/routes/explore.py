...
LLMService is used for /qa (text generation for Q&A answers).
Switching LLM providers for Q&A requires only LLM_PROVIDER env var.
"""
...
async def landmark_qa(
    ...
    """
    Answer a landmark question using LLMService (HuggingFace by default).
